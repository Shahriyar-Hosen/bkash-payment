...
const Header = () => {
  ...
  return (
    <Navbar collapseOnSelect expand="lg" className="header-de w-100 py-3">
      <Container>
        <img className="logo-design " src={logo} alt="" />
        <Navbar.Toggle aria-controls="responsive-navbar-nav" />
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            <Link className="link-design " to="/home">
              Home
            </Link>
            <Link className="link-design " to="/products">
              Products
            </Link>

            <Link className="link-design " to="/blog">
              Blog
            </Link>
          ...
          <Nav className="ms-auto me-5 flex items-center ">
            {user.email ? (
              <>
                ...
                <HashLink
                  className="btn-cart text-2xl mx-2 "
                  smooth
                  to="/placeorder"
                >
                  {" "}
